...
//                                                + "\\" + options.decimalSeparator + "?\\d{0," + maxDecimals + "}$";
                                ...
                                addCommasToInteger = function(val) {
                                    ...
                                    //Modificamos esto para que busque los decimales a partir del . (teclado numerico!!!) independientemente del caracter customizado
                                    var dsi = val.indexOf(".");
                                    if (dsi >= 0 && dsi < val.length - 1) {
                                        decimals = val.substring(dsi);
                                        decimals = decSep + decimals.substring(1);
                                    }
                                    //Idem aqui
